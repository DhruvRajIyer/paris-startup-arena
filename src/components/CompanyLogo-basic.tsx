...
export function CompanyLogo({ company, size = 32, isHovered = false }: CompanyLogoProps) {
  ...
  const logoUrl = domain ? `https://img.logo.dev/${domain}?token=${import.meta.env.VITE_LOGO_DEV_API_KEY}` : null;
